                        ...
                        <div class="element-detail-box">
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    ...
                                    <div>
                        <table id="dg" class="easyui-datagrid table table-bordered table-striped" style="height:auto"
                           data-options="iconCls: 'icon-edit', url: '/static/datas/datagrid_data1.json', method: 'get', onClickRow: onClickRow">
                            <thead>
                                <tr>
                                    <th data-options="field:'ck',checkbox:true">ok</th>
                                    <th data-options="field:'column',width:80">数据表列名</th>
                                    ...
                                    <th data-options="field:'type',width:100,
                                        ...
                                        editor:{
                                            ...
                                            options:{
                                                ...
                                                method:'get',
                                                dataType: 'jsonp',
                                                url:'http://localhost:8080/zkyunso/dataimport/tokenizer/1',
                                                required:true
                                            }
                                        }">分词器
                                    </th>
